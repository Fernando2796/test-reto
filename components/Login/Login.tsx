...
export const Login = () => {
  ...
  const checkUserExists = (userExists: boolean) => {
    if (userExists) {
      dispatch(saveLoginData(userExists));
  ...
  return (
    <>
      <div className="flex min-h-full flex-col justify-center px-6 py-5 lg:px-8 items-center">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-sky-800 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 items-center"
              >
                {loading ? (
                  <>
                    <svg
